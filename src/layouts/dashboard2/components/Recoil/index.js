...
export const datosRes = atom({
  ...
  default: {
    ...
    resultadosCondensacion: [{ msg: ["Todavía no se procesaron datos", ""] }],
    resultadosIncidencia: [{ msg: ["Todavía no se procesaron datos", ""] }],
  }, // Valor inicial
});
  ...
  default: {
    cooling: {
      ...
      envelope: {
        ...
        roofs: [
          { K: 2.2, A: 44.0, ori: "N", Te_eff: 30.23 }, // te + ~10°C soleado
        ],
        floors: [{ K: 1.2, A: 42.0, Te_eff: 12 }],
        doors: [
          { K: 2.0, A: 1.9, ori: "W" }, // 1 puerta típica 0.9×2.1 m
        ],
      },
      ...
      lighting: [{ A: 42, q_ilum: 10, CT: 0.2 }],
